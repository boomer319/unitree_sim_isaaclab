...
class ObjectTableSceneCfg(TableRedBlockSceneCfg):
    ...
    front_camera: CameraCfg = CameraPresets.h12_front_camera()
    left_wrist_camera: CameraCfg = CameraPresets.left_inspire_wrist_camera()
    right_wrist_camera: CameraCfg = CameraPresets.right_inspire_wrist_camera()
